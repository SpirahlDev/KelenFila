...
--
-- Hôte : localhost:3306
-- Généré le : dim. 14 mai 2023 à 03:42
...
(2, 'Électroménager & Matériel professionnel', NULL, 'Plongez dans notre catégorie Électroménager et matériel professionnel où vous trouverez une sélection complète d\'équipements professionnels pour répondre à vos besoins'),
...
(5, 'Voitures de sport et de collection', NULL, 'Que vous soyez un passionné de vitesse ou un collectionneur averti, notre collection de voiture vous fera battre le cœur au plus vite.'),
...
(11, 'Vins & Spiritueux', NULL, 'Que vous soyez un collectionneur passionné ou simplement un amateur de bons breuvages, notre sélection saura éveiller vos papilles'),
...
(14, 'Divers', NULL, 'Laissez vous surprendre');
...
(43, 'AlloueENCH0', '2023-05-13 15:30:00', '01:25', 5, 18),
(44, 'AlloueENCH1', '2023-05-13 16:02:00', '02:02', 5, 18),
(45, 'AlloueENCH2', '2023-05-13 14:11:00', '02:11', 8, 18),
(46, 'AlloueENCH3', '2023-05-10 18:24:00', '03:23', 10, 18),
(47, 'AlloueENCH4', '2023-05-09 03:39:00', '04:39', 8, 18),
(48, 'AlloueENCH5', '2023-05-02 03:44:00', '01:04', 1, 18),
(49, 'AlloueENCH6', '2023-05-13 16:00:00', '02:00', 5, 18);
...
CREATE TABLE `lot` (
  ...
  `isEnded` tinyint(4) DEFAULT NULL,
...
INSERT INTO `lot` (`idLot`, `designLot`, `descriptionLot`, `etatLot`, `estimatLot`, `dateAjout`, `numeroLot`, `image1`, `image2`, `image3`, `image4`, `image5`, `image6`, `isEnded`, `prixVendue`, `idEnchere`) VALUES
(14, 'Buggati Type 57', 'Cette voiture de collection exceptionnelle est un véritable chef-d’œuvre d’ingénierie et de design. Avec son histoire fascinante et sa restauration méticuleuse, elle est prête à être appréciée par un nouveau propriétaire passionné. Ne manquez pas cette occasion unique de posséder l’une des voitures les plus emblématiques et les plus recherchées de tous les temps.', 'Très bien conservé', 23000000, '2023-05-13 01:27:23', 1, '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH043-Buggati Type 571.png', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH043-Buggati Type 572.', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH043-Buggati Type 573.', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH043-Buggati Type 574.', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH043-Buggati Type 575.', ' ', NULL, NULL, 43),
(15, 'Jaguar Type E', 'Cette voiture d’exception a appartenu à Steve McQueen qui l’a offert à son chef cuisinier. Elle était dans les coursives du film Le Mans et est une version rare et unique avec ses clignotants orange, caractéristiques de la version américaine.', 'Bien conservé', 44000000, '2023-05-13 02:05:50', 1, '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH044-Jaguar Type E1.jpg', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH044-Jaguar Type E2.', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH044-Jaguar Type E3.', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH044-Jaguar Type E4.', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH044-Jaguar Type E5.', ' ', NULL, NULL, 44),
(16, 'African Masque', 'Ils ont une signification culturelle particulière et sont associés indissolublement au savoir et au pouvoir. Les masques sont destinés à masquer l’identité de celui qui le porte afin de lui permettre de personnifier un esprit, un dieu ou une quelconque force surnaturelle.', 'Bon Etat', 44400, '2023-05-13 02:05:50', 2, '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH044-African Masque1.jpeg', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH044-African Masque2.', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH044-African Masque3.', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH044-African Masque4.', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH044-African Masque5.', ' ', NULL, NULL, 44),
(17, 'Lady-Datejust', 'La montre  de Rolex qui associe or jaune et diamants en est un bon exemple avec au niveau du cadran qui se marie parfaitement avec le bracelet', 'Neuf', 400000, '2023-05-13 02:14:37', 1, '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH045-Lady-Datejust1.png', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH045-Lady-Datejust2.', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH045-Lady-Datejust3.', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH045-Lady-Datejust4.', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH045-Lady-Datejust5.', ' ', NULL, NULL, 45),
(18, 'CTF Pink Star', ' Il s’agit d’un diamant rose vif ovale de 59,60 carats, sans défaut interne, vendu chez Sotheby’s à Hong Kong en avril 2017 pour 71,2 millions de dollars américains. C’est un prix record mondial pour tout diamant ou bijou', 'Excellent', 7100000000, '2023-05-13 02:27:37', 1, '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH046-CTF Pink Star1.jpg', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH046-CTF Pink Star2.', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH046-CTF Pink Star3.', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH046-CTF Pink Star4.', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH046-CTF Pink Star5.', ' ', 1, NULL, 46),
(19, 'Appel Watch', 'L’Apple Watch est une montre connectée produite par Apple Inc. Elle intègre des fonctionnalités de suivi de la condition physique, des capacités axées sur la santé et des télécommunications sans fil, et s’intègre à iOS et à d’autres produits et services Apple. Elle permet aux utilisateurs d’accomplir une variété de tâches, y compris passer des appels téléphoniques, envoyer des messages texte et lire des e-mails .', 'Neuf', 48400, '2023-05-13 02:41:09', 1, '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH047-Appel Watch1.png', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH047-Appel Watch2.', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH047-Appel Watch3.', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH047-Appel Watch4.', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH047-Appel Watch5.', ' ', 1, NULL, 47),
(20, 'Buffet vintage ARNAUD', 'Un beau buffet à deux compartiments. Un style vintage et chic en même temps. Une sublime couleur verte avec un plateau en bois. Cet ancien meuble de caractère pourra être la pièce maitresse de votre intérieur ', 'Bon Etat', 300000, '2023-05-13 02:45:56', 1, '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH048-Buffet vintage ARNAUD1.jpg', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH048-Buffet vintage ARNAUD2.', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH048-Buffet vintage ARNAUD3.', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH048-Buffet vintage ARNAUD4.', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH048-Buffet vintage ARNAUD5.', ' ', 1, NULL, 48),
(21, 'Porsche Modèle Macan', 'PORSCHE Modéle : MACAN S 3.0 TDI V6 24V AWD PDK 258 cv\r\nAnnée : 2014\r\nN°de Série : WP1ZZZ95ZELB70724 Date de 1ere mise en service 05/01/2014 Energie : Diesel\r\nPuissance : 16 cv\r\n102360 KMS\r\noptions : S 3.0 TDI V6 24V AWD PDK 258 cv\r\nBoîte auto transmission à double embrayage Porsche 4x4 à LA REQUETE DE L\'AGRASC\r\n', 'Etat de marche', 19650000, '2023-05-13 08:32:32', 1, '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH049-Porsche Modèle Macan1.webp', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH049-Porsche Modèle Macan2.webp', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH049-Porsche Modèle Macan3.webp', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH049-Porsche Modèle Macan4.webp', '../../../FTP-server/lots/AlloueAnselme Emmanuel18/ENCH049-Porsche Modèle Macan5.webp', ' ', NULL, NULL, 49);
...
CREATE TABLE `voiePaiement` (
  `idvoiePaiement` int(11) NOT NULL,
  `libellePaiement` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
...
--
-- Index pour la table `voiePaiement`
--
ALTER TABLE `voiePaiement`
  ADD PRIMARY KEY (`idvoiePaiement`);
...
--
ALTER TABLE `enchere`
  MODIFY `idEnchere` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
--
ALTER TABLE `lot`
  MODIFY `idLot` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
-- AUTO_INCREMENT pour la table `voiePaiement`
--
ALTER TABLE `voiePaiement`
  MODIFY `idvoiePaiement` int(11) NOT NULL AUTO_INCREMENT;
